...
class SettingsActivity : AppCompatActivity() {
    ...
    private val settingList by lazy {
        mutableListOf(
            ...
            SettingsModel.GeneralItem(getString(R.string.image_quality), R.drawable.setting_image_quality_ic,
                getString(this@SettingsActivity, KEY_IMAGE_QUALITY,getString(R.string.high)),R.drawable.setting_up_down_ic),
//            SettingsModel.GeneralItem(getString(R.string.volume_button), R.drawable.setting_volume_ic,"Capture photo",R.drawable.setting_up_down_ic),
            SettingsModel.GeneralItem(getString(R.string.touch_settings), R.drawable.setting_touch_ic,getString(this@SettingsActivity, KEY_TOUCH_SETTING,getString(R.string.focus)),R.drawable.setting_up_down_ic),
...
//            SettingsModel.FeaturesItem(getString(R.string.front_rear_camera_stamp), R.drawable.setting_front_rear_ic),
            ...
            SettingsModel.Heading(getString(R.string.version, BuildConfig.VERSION_NAME)), // Version item
        )
    }
    ...
    private fun setupRecyclerView() {
        languageAdapter = SettingsAdapter(settingList, ::onItemClick,::onMenuClick)
    ...
    private fun onMenuClick(textView:TextView,title : String){
        val imageQuality = listOf( getString(R.string.low),  getString(R.string.medium),  getString(R.string.high))
        ...
        when(title){
            getString(R.string.image_quality)->{
                textView.showDropdownMenu(imageQuality){selected->
                    ...
                    when(selected)
                    {
                        getString(R.string.low)-> CameraSettingsNotifier.notifyQualityChanged(ImageQuality.LOW)
                        getString(R.string.medium)-> CameraSettingsNotifier.notifyQualityChanged(ImageQuality.MEDIUM)
                        getString(R.string.high)-> CameraSettingsNotifier.notifyQualityChanged(ImageQuality.HIGH)
                    }
