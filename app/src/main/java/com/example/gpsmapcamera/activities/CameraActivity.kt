...
class CameraActivity : BaseActivity(), CameraSettingsListener {
    ...
    private val fromVideoSelected by lazy {
        intent.getBooleanExtra(Constants.FROM_HOME_VIDEO_SELECTED, false)
    }

    private val fromQuickShareSelected by lazy {
        intent.getBooleanExtra(Constants.FROM_HOME_QUICK_SHARE_SELECTED, false)
    }
