...
class StampFontSizeAdapter(
    private val dataList: List<String>,
    private val passedTemplate : String,
    private val onItemClick: (Int) -> Unit
) : RecyclerView.Adapter<StampFontSizeAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: SingleDateFormatBinding) : RecyclerView.ViewHolder(binding.root) {
        init {
            selectedPosition = getInt(binding.root.context, Constants.SELECTED_STAMP_SIZE + passedTemplate , 0)
        }
